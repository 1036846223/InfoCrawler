...
import zero.info.selector.Html;
import zero.info.selector.Json;
import zero.info.selector.Selectable;
 ...
 * {@link #getResultItems()} get extract results threao be used in {@link us.codecraft.webmagic.pipeline.Pipeline}<br>
